...
class InceptionV1_I3D(nn.Module):
    ...
    def __init__(self, 
        ...
        inplace = True
        self.conv1_7x7_s2 = nn.Conv3d(3, 64, kernel_size=(7, 7, 7), stride=(2, 2, 2), padding=(3, 3, 3))
        self.conv1_7x7_s2_bn = nn.BatchNorm3d(64, eps=1e-05, momentum=0.9, affine=True)
        self.conv1_relu_7x7 = nn.ReLU (inplace)
        self.pool1_3x3_s2 = nn.MaxPool3d ((1, 3, 3), stride=(1, 2, 2), dilation=(1, 1, 1), ceil_mode=True)
        self.conv2_3x3_reduce = nn.Conv3d(64, 64, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.conv2_3x3_reduce_bn = nn.BatchNorm3d(64, eps=1e-05, momentum=0.9, affine=True)
        self.conv2_relu_3x3_reduce = nn.ReLU (inplace)
        self.conv2_3x3 = nn.Conv3d(64, 192, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
        self.conv2_3x3_bn = nn.BatchNorm3d(192, eps=1e-05, momentum=0.9, affine=True)
        self.conv2_relu_3x3 = nn.ReLU (inplace)
        self.pool2_3x3_s2 = nn.MaxPool3d ((1, 3, 3), stride=(1, 2, 2), dilation=(1, 1, 1), ceil_mode=True)

        ##########
        self.inception_3a_1x1 = nn.Conv3d(192, 64, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_3a_1x1_bn = nn.BatchNorm3d(64, eps=1e-05, momentum=0.9, affine=True)
        self.inception_3a_relu_1x1 = nn.ReLU (inplace)

        self.inception_3a_branch1_3x3_reduce = nn.Conv3d(192, 96, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_3a_branch1_3x3_reduce_bn = nn.BatchNorm3d(96, eps=1e-05, momentum=0.9, affine=True)
        self.inception_3a_branch1_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_3a_branch1_3x3 = nn.Conv3d(96, 128, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
        self.inception_3a_branch1_3x3_bn = nn.BatchNorm3d(128, eps=1e-05, momentum=0.9, affine=True)
        self.inception_3a_branch1_relu_3x3 = nn.ReLU (inplace)
        
        self.inception_3a_branch2_3x3_reduce = nn.Conv3d(192, 16, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_3a_branch2_3x3_reduce_bn = nn.BatchNorm3d(16, eps=1e-05, momentum=0.9, affine=True)
        self.inception_3a_branch2_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_3a_branch2_3x3 = nn.Conv3d(16, 32, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
        self.inception_3a_branch2_3x3_bn = nn.BatchNorm3d(32, eps=1e-05, momentum=0.9, affine=True)
        self.inception_3a_branch2_relu_3x3 = nn.ReLU (inplace)

        self.inception_3a_pool = nn.AvgPool3d (3, stride=1, padding=1, ceil_mode=True, count_include_pad=True)
        self.inception_3a_pool_proj = nn.Conv3d(192, 32, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_3a_pool_proj_bn = nn.BatchNorm3d(32, eps=1e-05, momentum=0.9, affine=True)
        self.inception_3a_relu_pool_proj = nn.ReLU (inplace)

        self.inception_3b_1x1 = nn.Conv3d(256, 128, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_3b_1x1_bn = nn.BatchNorm3d(128, eps=1e-05, momentum=0.9, affine=True)
        self.inception_3b_relu_1x1 = nn.ReLU (inplace)
        
        self.inception_3b_branch1_3x3_reduce = nn.Conv3d(256, 128, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_3b_branch1_3x3_reduce_bn = nn.BatchNorm3d(128, eps=1e-05, momentum=0.9, affine=True)
        self.inception_3b_branch1_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_3b_branch1_3x3 = nn.Conv3d(128, 192, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
        self.inception_3b_branch1_3x3_bn = nn.BatchNorm3d(192, eps=1e-05, momentum=0.9, affine=True)
        self.inception_3b_branch1_relu_3x3 = nn.ReLU (inplace)

        self.inception_3b_branch2_3x3_reduce = nn.Conv3d(256, 32, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_3b_branch2_3x3_reduce_bn = nn.BatchNorm3d(32, eps=1e-05, momentum=0.9, affine=True)
        self.inception_3b_branch2_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_3b_branch2_3x3 = nn.Conv3d(32, 96, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
        self.inception_3b_branch2_3x3_bn = nn.BatchNorm3d(96, eps=1e-05, momentum=0.9, affine=True)
        self.inception_3b_branch2_relu_3x3 = nn.ReLU (inplace)

        self.inception_3b_pool = nn.AvgPool3d (3, stride=1, padding=1, ceil_mode=True, count_include_pad=True)
        self.inception_3b_pool_proj = nn.Conv3d(256, 64, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_3b_pool_proj_bn = nn.BatchNorm3d(64, eps=1e-05, momentum=0.9, affine=True)
        self.inception_3b_relu_pool_proj = nn.ReLU (inplace)

        self.inception_3c_pool = nn.MaxPool3d((3, 3, 3), stride=(2, 2, 2), dilation=(1, 1, 1), ceil_mode=True)

        ##########
        self.inception_4a_1x1 = nn.Conv3d(480, 192, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4a_1x1_bn = nn.BatchNorm3d(192, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4a_relu_1x1 = nn.ReLU (inplace)

        self.inception_4a_branch1_3x3_reduce = nn.Conv3d(480, 96, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4a_branch1_3x3_reduce_bn = nn.BatchNorm3d(96, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4a_branch1_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_4a_branch1_3x3 = nn.Conv3d(96, 208, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
        self.inception_4a_branch1_3x3_bn = nn.BatchNorm3d(208, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4a_branch1_relu_3x3 = nn.ReLU (inplace)

        self.inception_4a_branch2_3x3_reduce = nn.Conv3d(480, 16, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4a_branch2_3x3_reduce_bn = nn.BatchNorm3d(16, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4a_branch2_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_4a_branch2_3x3 = nn.Conv3d(16, 48, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
        self.inception_4a_branch2_3x3_bn = nn.BatchNorm3d(48, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4a_branch2_relu_3x3 = nn.ReLU (inplace)

        self.inception_4a_pool = nn.AvgPool3d (3, stride=1, padding=1, ceil_mode=True, count_include_pad=True)
        self.inception_4a_pool_proj = nn.Conv3d(480, 64, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4a_pool_proj_bn = nn.BatchNorm3d(64, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4a_relu_pool_proj = nn.ReLU (inplace)

        self.inception_4b_1x1 = nn.Conv3d(512, 160, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4b_1x1_bn = nn.BatchNorm3d(160, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4b_relu_1x1 = nn.ReLU (inplace)

        self.inception_4b_branch1_3x3_reduce = nn.Conv3d(512, 112, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4b_branch1_3x3_reduce_bn = nn.BatchNorm3d(112, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4b_branch1_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_4b_branch1_3x3 = nn.Conv3d(112, 224, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
        self.inception_4b_branch1_3x3_bn = nn.BatchNorm3d(224, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4b_branch1_relu_3x3 = nn.ReLU (inplace)

        self.inception_4b_branch2_3x3_reduce = nn.Conv3d(512, 24, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4b_branch2_3x3_reduce_bn = nn.BatchNorm3d(24, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4b_branch2_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_4b_branch2_3x3 = nn.Conv3d(24, 64, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
        self.inception_4b_branch2_3x3_bn = nn.BatchNorm3d(64, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4b_branch2_relu_3x3 = nn.ReLU (inplace)

        self.inception_4b_pool = nn.AvgPool3d (3, stride=1, padding=1, ceil_mode=True, count_include_pad=True)
        self.inception_4b_pool_proj = nn.Conv3d(512, 64, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4b_pool_proj_bn = nn.BatchNorm3d(64, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4b_relu_pool_proj = nn.ReLU (inplace)

        self.inception_4c_1x1 = nn.Conv3d(512, 128, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4c_1x1_bn = nn.BatchNorm3d(128, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4c_relu_1x1 = nn.ReLU (inplace)

        self.inception_4c_branch1_3x3_reduce = nn.Conv3d(512, 128, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4c_branch1_3x3_reduce_bn = nn.BatchNorm3d(128, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4c_branch1_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_4c_branch1_3x3 = nn.Conv3d(128, 256, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
        self.inception_4c_branch1_3x3_bn = nn.BatchNorm3d(256, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4c_branch1_relu_3x3 = nn.ReLU (inplace)

        self.inception_4c_branch2_3x3_reduce = nn.Conv3d(512, 24, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4c_branch2_3x3_reduce_bn = nn.BatchNorm3d(24, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4c_branch2_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_4c_branch2_3x3 = nn.Conv3d(24, 64, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
        self.inception_4c_branch2_3x3_bn = nn.BatchNorm3d(64, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4c_branch2_relu_3x3 = nn.ReLU (inplace)

        self.inception_4c_pool = nn.AvgPool3d (3, stride=1, padding=1, ceil_mode=True, count_include_pad=True)
        self.inception_4c_pool_proj = nn.Conv3d(512, 64, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4c_pool_proj_bn = nn.BatchNorm3d(64, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4c_relu_pool_proj = nn.ReLU (inplace)

        self.inception_4d_1x1 = nn.Conv3d(512, 112, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4d_1x1_bn = nn.BatchNorm3d(112, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4d_relu_1x1 = nn.ReLU (inplace)

        self.inception_4d_branch1_3x3_reduce = nn.Conv3d(512, 144, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4d_branch1_3x3_reduce_bn = nn.BatchNorm3d(144, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4d_branch1_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_4d_branch1_3x3 = nn.Conv3d(144, 288, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
        self.inception_4d_branch1_3x3_bn = nn.BatchNorm3d(288, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4d_branch1_relu_3x3 = nn.ReLU (inplace)
        
        self.inception_4d_branch2_3x3_reduce = nn.Conv3d(512, 32, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4d_branch2_3x3_reduce_bn = nn.BatchNorm3d(32, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4d_branch2_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_4d_branch2_3x3 = nn.Conv3d(32, 64, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
        self.inception_4d_branch2_3x3_bn = nn.BatchNorm3d(64, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4d_branch2_relu_3x3 = nn.ReLU (inplace)

        self.inception_4d_pool = nn.AvgPool3d (3, stride=1, padding=1, ceil_mode=True, count_include_pad=True)
        self.inception_4d_pool_proj = nn.Conv3d(512, 64, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4d_pool_proj_bn = nn.BatchNorm3d(64, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4d_relu_pool_proj = nn.ReLU (inplace)

        self.inception_4e_1x1 = nn.Conv3d(528, 256, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4e_1x1_bn = nn.BatchNorm3d(256, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4e_relu_1x1 = nn.ReLU (inplace)

        self.inception_4e_branch1_3x3_reduce = nn.Conv3d(528, 160, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4e_branch1_3x3_reduce_bn = nn.BatchNorm3d(160, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4e_branch1_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_4e_branch1_3x3 = nn.Conv3d(160, 320, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
        self.inception_4e_branch1_3x3_bn = nn.BatchNorm3d(320, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4e_branch1_relu_3x3 = nn.ReLU (inplace)
        
        self.inception_4e_branch2_3x3_reduce = nn.Conv3d(528, 32, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4e_branch2_3x3_reduce_bn = nn.BatchNorm3d(32, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4e_branch2_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_4e_branch2_3x3 = nn.Conv3d(32, 128, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
        self.inception_4e_branch2_3x3_bn = nn.BatchNorm3d(128, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4e_branch2_relu_3x3 = nn.ReLU (inplace)

        self.inception_4e_pool = nn.AvgPool3d (3, stride=1, padding=1, ceil_mode=True, count_include_pad=True)
        self.inception_4e_pool_proj = nn.Conv3d(528, 128, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_4e_pool_proj_bn = nn.BatchNorm3d(128, eps=1e-05, momentum=0.9, affine=True)
        self.inception_4e_relu_pool_proj = nn.ReLU (inplace)

        self.inception_4f_pool = nn.MaxPool3d ((3, 3, 3), stride=(2, 2, 2), dilation=(1, 1, 1), ceil_mode=True)

        ##########
        self.inception_5a_1x1 = nn.Conv3d(832, 256, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_5a_1x1_bn = nn.BatchNorm3d(256, eps=1e-05, momentum=0.9, affine=True)
        self.inception_5a_relu_1x1 = nn.ReLU (inplace)

        self.inception_5a_branch1_3x3_reduce = nn.Conv3d(832, 160, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_5a_branch1_3x3_reduce_bn = nn.BatchNorm3d(160, eps=1e-05, momentum=0.9, affine=True)
        self.inception_5a_branch1_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_5a_branch1_3x3 = nn.Conv3d(160, 320, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
        self.inception_5a_branch1_3x3_bn = nn.BatchNorm3d(320, eps=1e-05, momentum=0.9, affine=True)
        self.inception_5a_branch1_relu_3x3 = nn.ReLU (inplace)

        self.inception_5a_branch2_3x3_reduce = nn.Conv3d(832, 32, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_5a_branch2_3x3_reduce_bn = nn.BatchNorm3d(32, eps=1e-05, momentum=0.9, affine=True)
        self.inception_5a_branch2_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_5a_branch2_3x3 = nn.Conv3d(32, 128, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
        self.inception_5a_branch2_3x3_bn = nn.BatchNorm3d(128, eps=1e-05, momentum=0.9, affine=True)
        self.inception_5a_branch2_relu_3x3 = nn.ReLU (inplace)

        self.inception_5a_pool = nn.AvgPool3d (3, stride=1, padding=1, ceil_mode=True, count_include_pad=True)
        self.inception_5a_pool_proj = nn.Conv3d(832, 128, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_5a_pool_proj_bn = nn.BatchNorm3d(128, eps=1e-05, momentum=0.9, affine=True)
        self.inception_5a_relu_pool_proj = nn.ReLU (inplace)

        self.inception_5b_1x1 = nn.Conv3d(832, 384, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_5b_1x1_bn = nn.BatchNorm3d(384, eps=1e-05, momentum=0.9, affine=True)
        self.inception_5b_relu_1x1 = nn.ReLU (inplace)

        self.inception_5b_branch1_3x3_reduce = nn.Conv3d(832, 192, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_5b_branch1_3x3_reduce_bn = nn.BatchNorm3d(192, eps=1e-05, momentum=0.9, affine=True)
        self.inception_5b_branch1_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_5b_branch1_3x3 = nn.Conv3d(192, 384, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
        self.inception_5b_branch1_3x3_bn = nn.BatchNorm3d(384, eps=1e-05, momentum=0.9, affine=True)
        self.inception_5b_branch1_relu_3x3 = nn.ReLU (inplace)

        self.inception_5b_branch2_3x3_reduce = nn.Conv3d(832, 48, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_5b_branch2_3x3_reduce_bn = nn.BatchNorm3d(48, eps=1e-05, momentum=0.9, affine=True)
        self.inception_5b_branch2_relu_3x3_reduce = nn.ReLU (inplace)
        self.inception_5b_branch2_3x3 = nn.Conv3d(48, 128, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1))
        self.inception_5b_branch2_3x3_bn = nn.BatchNorm3d(128, eps=1e-05, momentum=0.9, affine=True)
        ...
        self.inception_5b_pool_proj = nn.Conv3d(832, 128, kernel_size=(1, 1, 1), stride=(1, 1, 1))
        self.inception_5b_pool_proj_bn = nn.BatchNorm3d(128, eps=1e-05, momentum=0.9, affine=True)
    ...
    def forward(self, input):
        ...
        inception_5b_1x1_out = self.inception_5b_1x1(inception_5a_pool_out)
        inception_5b_1x1_bn_out = self.inception_5b_1x1_bn(inception_5b_1x1_out)
        inception_5b_relu_1x1_out = self.inception_5b_relu_1x1(inception_5b_1x1_bn_out)
        inception_5b_branch1_3x3_reduce_out = self.inception_5b_branch1_3x3_reduce(inception_5a_pool_out)
        ...
        inception_5b_branch2_3x3_reduce_out = self.inception_5b_branch2_3x3_reduce(inception_5a_pool_out)
        ...
        inception_5b_pool_out = self.inception_5b_pool(inception_5a_pool_out)
