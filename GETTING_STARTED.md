...
```shell
python tools/test_recognizer.py configs/ucf101/tsn_rgb_bninception.py tsn_2d_rgb_bninception_seg3_f1s1_b32_g8-98160339.pth --gpus 1
python tools/test_recognizer.py configs/ucf101/tsn_rgb_bninception.py open-mmlab://bninception_caffe --gpus 2
```
